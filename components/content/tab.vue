<template>
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><i class="fa fa-bars"></i> Tabs <small>Float left <<>> {{ Descript }}</small></h2>
        <ul class="nav navbar-right panel_toolbox">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="javascript:void(0)"   v-on:click.stop="clickEvt($event)">Settings 1</a>
              </li>
...
export default {
  data () {
  return {
    Descript: 'This is a Data of My Test of Vue Data'
  }
}
,
methods:{
  clickEvt(e) {
    //向父组件传递参数
    this.$emit('listentToChildrenEvent', {
      isVisible: 'This is a msg from childTab'
    });
  }
},
}
